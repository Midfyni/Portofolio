...
const Hero = () => (
  <section className={`${styles.yPaddings} px-6 sm:px-16`}>
    <motion.div
      ...
      className="max-w-[1200px] mx-auto grid md:grid-cols-2 gap-10 items-center"
    >
      {/* Left side */}
      <div className="text-center md:text-left space-y-6">
        ...
        >
          <a href="#about" className="px-6 py-3 bg-blue-600 rounded-full text-white font-semibold hover:bg-blue-500 transition">
            Learn More
          </a>
          <a href="#projects" className="px-6 py-3 border border-white rounded-full text-white font-semibold hover:bg-gray-800 transition">
            View Projects
          </a>
        </motion.div>
      </div>
