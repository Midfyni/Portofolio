...
const Insights = () => {
  ...
  return (
    <section className={`${styles.paddings} relative z-10`}>
      ...
      >
        <TitleText title={<>Selected Project</>} textStyles="text-center" />
            ...
            >
              ...
              <div className="border-t border-gray-700 py-4 mt-4 flex justify-center gap-4 sticky bottom-0 z-20 bg-[#1a1a1a]">
                ...
                <a
                  ...
                  className="inline-flex items-center gap-2 px-5 py-2.5 border border-gray-600 text-white rounded-full hover:bg-gray-800 transition-colors duration-300"
                >
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-2 px-5 py-2.5 border border-purple-500 text-white rounded-full hover:bg-purple-600 hover:border-transparent transition-colors duration-300"
                >
